<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">X MP</h1>
    ...
    <div class="row">
        <div class="col-md">
            ...
            <form action="<?= base_url('agenda/mp'); ?>" method="post">
                ...
                <tbody>
                    ...
                    <?php foreach ($mp as $r) : ?>
                        <tr>
                            ...
                            <?php if ($user['role_id'] == 1) : ?>
                                <td>
                                    <a href="<?= base_url('agenda/gantimp/'); ?><?= $r['jam']; ?>" class="badge badge-success">edit</a>
                                    <a href="<?= base_url('agenda/hapusmp/'); ?><?= $r['jam']; ?>" class="badge badge-danger" onclick="return confirm('yakin hapus niee?');">delete</a>
                                </td>
                            <?php else : ?>
                            <?php endif; ?>
                        </tr>
